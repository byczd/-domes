...
static NSString * const kPDDictionaryKey = @"com.xiaozhu.dictionaryKey";
static NSString * const kPDKeyChainKey = @"com.xiaozhu.keychainKey";

@implementation PDKeyChain

+ (void)keyChainSave:(NSArray *)array {
    NSMutableDictionary *tempDic = [NSMutableDictionary dictionary];
    [tempDic setObject:array forKey:kPDDictionaryKey];
